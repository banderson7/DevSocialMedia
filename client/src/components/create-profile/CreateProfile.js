            ...
            <div className="col-md-8 a-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="* A unique handle/nickname for your profile URL."
                />
                <SelectListGroup
                  placeholder="Status"
                  name="status"
                ...
                <TextFieldGroup
                  ...
                  info="The company you own or work for."
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
                ...
                <TextFieldGroup
                  ...
                  info="Will display your latest repos and a link to GitHub if you enter your GitHub username."
                />
                <TextAreaFieldGroup
